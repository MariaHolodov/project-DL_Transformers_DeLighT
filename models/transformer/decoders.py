...
class MeshedDecoderLayer(Module):
    def __init__(self, d_model=64, d_middle=[768,1024,512], d_o=256, d_k=64, d_v=64, h=1, d_ff=128, dropout=.1, self_att_module=None,
...
class MeshedDecoder(Module):
    def __init__(self, vocab_size, max_len, N_dec, padding_idx, d_model=512, d_middle=[768,1024,512], d_o=256, d_k=64, d_v=64, h=1, d_ff=128, dropout=.1,
