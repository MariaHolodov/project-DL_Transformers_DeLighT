...
class MeshedDecoderLayer(Module):
    def __init__(self, d_model=64, d_k=64, d_v=64, h=1, d_ff=2048, dropout=.1, self_att_module=None,
...
class MeshedDecoder(Module):
    def __init__(self, vocab_size, max_len, N_dec, padding_idx, d_model=64, d_k=64, d_v=64, h=1, d_ff=2048, dropout=.1,
